...
name: ndv-map-first
description: >
  Complete-picture cognitive module. Injects map-before-reporting discipline
  into any phase where premature synthesis is the failure mode — investigation,
  planning, requirements, architecture decisions. A partial answer is not a
  smaller answer. It is a wrong answer. Source: ndv-research (Scout).
user-invocable: false
metadata:
  type: cognitive-module
  origin: agent-derived
  source-agent: ndv-research
---
